...
app.get(`${basePath}/IGProfilesList`, async (req, res) => {
  let client;
  try {
...
app.put(`${basePath}/IGProfilesList/:id`, async (req, res) => {
  const { id } = req.params;
...
app.post(`${basePath}/IGProfilesList`, async (req, res) => {
...
app.delete(`${basePath}/IGProfilesList/:id`, async (req, res) => {
